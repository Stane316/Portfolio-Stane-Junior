...
export const translations: Record<Language, Record<string, string>> = {
  ...
  en: {
    ...
    'about.text.p4': "Recently, my journey has taken a new direction. Artificial intelligence isn't a trend for me — it's the natural extension of how I think. Observe a system, understand its logic, then design solutions that learn and adapt. That's the logical next step from everything I've built so far. My goal: become an AI Systems Engineer capable of combining software engineering and artificial intelligence for Africa.",
    'about.conclusion': "I'm a software engineer in the making. I observe, I understand, I build. And today, I build intelligent systems.",
