              ...
              <form onSubmit={handleSubmit} className="space-y-4" noValidate>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input id="project-title-fr" type="text" value={formData.title_fr} onChange={(e) => { setFormData({ ...formData, title_fr: e.target.value }); setFormErrors({ ...formErrors, title_fr: '' }); }} required className={`w-full px-3 py-2 bg-[#141430] border rounded-lg text-white text-sm focus:outline-none focus:border-[#00BFFF] ${formErrors.title_fr ? 'border-red-500' : 'border-[rgba(0,191,255,0.15)]'}`} aria-invalid={!!formErrors.title_fr} aria-describedby={formErrors.title_fr ? 'error-title-fr' : undefined} />
                  ...
                  <div>
                    ...
                    <input id="project-title-en" type="text" value={formData.title_en} onChange={(e) => { setFormData({ ...formData, title_en: e.target.value }); setFormErrors({ ...formErrors, title_en: '' }); }} required className={`w-full px-3 py-2 bg-[#141430] border rounded-lg text-white text-sm focus:outline-none focus:border-[#00BFFF] ${formErrors.title_en ? 'border-red-500' : 'border-[rgba(0,191,255,0.15)]'}`} aria-invalid={!!formErrors.title_en} />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <textarea id="project-desc-fr" value={formData.description_fr} onChange={(e) => { setFormData({ ...formData, description_fr: e.target.value }); setFormErrors({ ...formErrors, description_fr: '' }); }} rows={2} required className={`w-full px-3 py-2 bg-[#141430] border rounded-lg text-white text-sm resize-none focus:outline-none focus:border-[#00BFFF] ${formErrors.description_fr ? 'border-red-500' : 'border-[rgba(0,191,255,0.15)]'}`} aria-invalid={!!formErrors.description_fr} />
                  ...
                  <div>
                    ...
                    <textarea id="project-desc-en" value={formData.description_en} onChange={(e) => { setFormData({ ...formData, description_en: e.target.value }); setFormErrors({ ...formErrors, description_en: '' }); }} rows={2} required className={`w-full px-3 py-2 bg-[#141430] border rounded-lg text-white text-sm resize-none focus:outline-none focus:border-[#00BFFF] ${formErrors.description_en ? 'border-red-500' : 'border-[rgba(0,191,255,0.15)]'}`} aria-invalid={!!formErrors.description_en} />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input id="project-url" type="url" value={formData.live_url} onChange={(e) => { setFormData({ ...formData, live_url: e.target.value }); setFormErrors({ ...formErrors, live_url: '' }); }} className={`w-full px-3 py-2 bg-[#141430] border rounded-lg text-white text-sm focus:outline-none focus:border-[#00BFFF] ${formErrors.live_url ? 'border-red-500' : 'border-[rgba(0,191,255,0.15)]'}`} aria-invalid={!!formErrors.live_url} />
                  ...
                  <tr key={project.id} className="border-b border-[rgba(0,191,255,0.1)] hover:bg-[#141430] hover:bg-opacity-50 transition-colors">
                    <td className="py-3 px-4">
                      <div className="flex flex-col gap-1">
                        <button onClick={() => moveOrder(project.id, 'up')} className="text-[#A8B4C8] hover:text-white transition-colors" disabled={projects.indexOf(project) === 0} aria-label="Monter">
                          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 15l7-7 7 7" /></svg>
                        </button>
                        <span className="text-center text-[#A8B4C8] font-mono text-xs">{project.display_order}</span>
                        <button onClick={() => moveOrder(project.id, 'down')} className="text-[#A8B4C8] hover:text-white transition-colors" disabled={projects.indexOf(project) === projects.length - 1} aria-label="Descendre">
                    ...
                    <td className="py-3 px-4 text-center">
                      <button onClick={() => toggleField(project.id, 'is_visible', project.is_visible)} className={`relative w-10 h-5 rounded-full transition-colors ${project.is_visible ? 'bg-[#00BFFF]' : 'bg-[#4A5568]'}`} role="switch" aria-checked={project.is_visible} aria-label="Toggle visibilité">
                    ...
                    <td className="py-3 px-4 text-center">
                      <button onClick={() => toggleField(project.id, 'is_featured', project.is_featured)} className={`relative w-10 h-5 rounded-full transition-colors ${project.is_featured ? 'bg-yellow-500' : 'bg-[#4A5568]'}`} role="switch" aria-checked={project.is_featured} aria-label="Toggle featured">
