        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            {breadcrumb && breadcrumb.length > 0 && (
              <nav className="flex items-center gap-1 text-xs text-[#4A5568] mb-0.5" aria-label="Fil d'Ariane">
                <span>Admin</span>
        ...
        <div className="flex items-center gap-3">
          {unreadCount > 0 && (
            <div className="relative">
              <div className="p-2 text-[#A8B4C8] hover:text-white transition-colors" title={`${unreadCount} messages non lus`}>
