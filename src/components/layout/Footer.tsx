            ...
            <ul className="space-y-2">
              {footerLinks.map((link) => (
                <li key={link.href}>
                  <a
                    href={link.href}
                    className="text-[#A8B4C8] hover:text-[#00BFFF] transition-colors text-sm"
                  >
                    {link.label}
                  </a>
                </li>
            ...
            <div className="flex gap-4">
              {socialLinks.map((social) => (
                <a
                  ...
                  className={`p-3 glass rounded-lg text-[#A8B4C8] ${social.color} text-white transition-all duration-300 hover:shadow-lg`}
