        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              ...
              <span className="w-2 h-2 bg-[var(--accent-cyan)] rounded-full" />
            </div>
            ...
            <div className="flex gap-4">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="p-3 glass rounded-lg text-[var(--text-secondary)] 
                           hover:text-[var(--accent-cyan)] hover:glow-cyan-hover 
